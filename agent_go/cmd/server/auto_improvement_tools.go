	...
	params := map[string]interface{}{
		...
		"properties": map[string]interface{}{
			...
			"source": map[string]interface{}{
				...
				"properties": map[string]interface{}{
					"type":       map[string]interface{}{"type": "string", "enum": []string{"eval_step", "telemetry", "external", "delayed_ground_truth"}, "description": "Source kind. Four valid values, listed in the parent description."},
