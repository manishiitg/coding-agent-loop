...
func TestWorkManifestDeclaresProjectScopeAndCodingAllowlist(t *testing.T) {
	...
	wantEnabled := map[string]bool{
		...
		"send_slack_message": false, "get_slack_bot_settings": false, "test_slack_bot_connection": false, "create_slack_bot_route": false, "update_slack_bot_route_permission": false, "remove_slack_bot_route": false,
