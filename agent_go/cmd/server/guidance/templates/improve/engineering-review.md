...
1. Load and apply `read_skill(skills=[{"name":"builder-reference","path":"references/pulse-review-fixer.md"}])`, then load and apply `read_skill(skills=[{"name":"builder-reference","path":"references/ops-review.md"}])`.
