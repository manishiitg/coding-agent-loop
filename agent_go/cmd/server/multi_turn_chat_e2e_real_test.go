...
// TestMultiTurnChatE2E_Gemini covers Gemini CLI's native session resume
// (--resume <id>) and transcript-file sidecar token extraction
...
// emit cost_usd_estimated (tracked in cost_http_e2e_gemini_real_test.go).
