...
var referenceKinds = map[string]kindMeta{
	...
	"webhook-triggers":  {Group: "system", Description: "Create, authenticate and test inbound route webhooks with manage_workflow_webhook; inspect accepted runs and distinguish internal testing from public delivery", Modes: []string{"workshop"}},
