...
### Before Running Any Step — Determine Group
...
### Running Steps
1. User says "run step-X" → determine group (see above) → call **execute_step("step-id", group_id=group_id)** → get execution_id (iteration defaults to iteration-0)
