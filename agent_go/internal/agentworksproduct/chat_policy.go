...
func validateChatPolicy(m ProductManifest) error {
	...
	known := map[string]bool{"user_management": true, "mcp_management": true, "plan_authoring": true, "report_authoring": true, "secret_management": true, "knowledgebase_maintenance": true, "improvement_proposals": true, "workspace_ui": true, "bot_management": true}
