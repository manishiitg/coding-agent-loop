...
var featureCatalog = map[string]featureDefinition{
	...
	"secrets": {
		Tools:           []string{"list_secrets", "set_workflow_secret", "delete_workflow_secret", "set_user_secret", "delete_user_secret", "manage_global_secret", "update_project_global_secret_selection"},
