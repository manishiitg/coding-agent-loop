...
var referenceKinds = map[string]kindMeta{
	...
	"review-improve-log-skeleton": {Group: "system", Description: "Copy-paste starter HTML skeleton for builder/improve.html, including mobile-first Pulse dashboard CSS, filter controls, card examples, decision grids, human-input card shape, and the stable newest-first insertion anchor. Load only when creating a new Pulse log or doing the one-time old-format upgrade required by review-improve-log.", Modes: []string{"workshop", "run"}},
