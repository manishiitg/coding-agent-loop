...
var referenceKinds = map[string]kindMeta{
	...
	"reporting-policy":        {Group: "system", Description: "HTML report contract: db/reports/index.html, goal/evaluation/cost data helpers and prebuilt widgets, live data and field writes, approval-save then sendChatMessage to an existing/new workflow chat, queued/cancelled receipts, authoring, refresh, preview, and Run-mode boundaries. Load for reports, dashboards, report action buttons, agent chat handoffs, themes, or layouts.", Modes: []string{"workshop", "run"}},
