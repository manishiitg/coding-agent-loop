...
Status: catalog in progress, 2026-09-26. **33 Crew templates are installable locally:** five Finance, ten Website Growth, three Sales, three Customer Success, four Engineering, three QA, and five Shopify. The remaining Crew names in this document are proposals. The ten multi-Crew Automation Playbooks below are installable chat proposals, not active automations. This document is a product map, not evidence that a customer has connected tools, completed setup, or achieved an outcome. The expanded Shopify library on this branch has not been deployed to Dominion; the earlier four-Crew/two-Playbook Shopify release is live there.
