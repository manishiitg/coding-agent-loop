...
const classifyPhase = (phase: string): StageBucket => {
  ...
  if (phase === 'harden_workflow' || phase === 'review_step_code' || phase === 'goal_advisor' || phase === 'plan_change') return 'workshop'
  return 'other'
}
                                        ...
                                        const modelSteps = runCost.tokenUsage && runCost.tokenUsage.by_step_and_model
                                          ? Object.entries(runCost.tokenUsage.by_step_and_model)
                                              .map(([stepKey, modelMap]) => {
                                                ...
                                                else if (phase === 'harden_workflow' || phase === 'review_step_code' || phase === 'goal_advisor' || phase === 'plan_change') { phaseLabel = 'Workshop' }
