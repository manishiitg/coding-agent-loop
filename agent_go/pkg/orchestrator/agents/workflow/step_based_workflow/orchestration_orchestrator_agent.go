...
type WorkflowOrchestrationOrchestratorAgent struct {
	*agents.BaseOrchestratorAgent
}

// NewWorkflowOrchestrationOrchestratorAgent creates a new orchestration orchestrator agent
func NewWorkflowOrchestrationOrchestratorAgent(config *agents.OrchestratorAgentConfig, logger loggerv2.Logger, tracer observability.Tracer, eventBridge mcpagent.AgentEventListener) *WorkflowOrchestrationOrchestratorAgent {
	...
	return &WorkflowOrchestrationOrchestratorAgent{
...
func (hctpooa *WorkflowOrchestrationOrchestratorAgent) Execute(ctx context.Context, templateVars map[string]string, conversationHistory []llmtypes.MessageContent) (string, []llmtypes.MessageContent, error) {
...
func (hctpooa *WorkflowOrchestrationOrchestratorAgent) ExecuteStructured(ctx context.Context, templateVars map[string]string, conversationHistory []llmtypes.MessageContent) (*OrchestrationResponse, []llmtypes.MessageContent, error) {
...
func (hctpooa *WorkflowOrchestrationOrchestratorAgent) orchestrationOrchestratorSystemPromptProcessorStructured(templateVars map[string]string) string {
	now := time.Now()
