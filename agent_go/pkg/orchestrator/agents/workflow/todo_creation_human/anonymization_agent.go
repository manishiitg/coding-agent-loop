...
**PRIMARY GOAL**: Scan the learnings folder and replace actual values with variable placeholders to make learnings reusable across different environments.
...
6. **Process both file types**:
   - .md files in learnings/
   - .py files in learnings/scripts/

**Remember**: 
- You have access ONLY to the learnings/ folder
