...
it('opens a catalog playbook and installs it for Builder setup', async () => {
  ...
  try {
    ...
    expect(container.textContent).toContain('Agentic Engineering Platform 1 small-team playbooks')
    ...
    await click(container.querySelector('[aria-label="What Basic Browser Setup is about"]'))
    expect(playbooksApi.install).not.toHaveBeenCalled()
