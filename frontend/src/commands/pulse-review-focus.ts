...
export const pulseReviewFocuses: PulseReviewFocus[] = [
  ...
  { id: 'measurement', label: 'Measurement quality', description: 'Whether measurement captures the intended outcomes correctly.',
    legacyCommand: 'pulse-review-evaluation-quality', argumentNames: ['measurement', 'measurements', 'measurement-quality', 'evaluation', 'evaluations', 'evaluation-quality'], instructions: technicalFocus('measurement_quality_truth') },
