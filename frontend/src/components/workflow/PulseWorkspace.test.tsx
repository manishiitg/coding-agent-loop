...
describe('PulseWorkspace information hierarchy', () => {
  it('shows drift status and review coverage before findings', () => {
    ...
    expect(html.indexOf('Needs your decision')).toBeLessThan(html.indexOf('Progress toward goals'))
    ...
    for (const label of ['Health', 'Strategy', 'Learnings', 'Knowledge base', 'Dashboard accuracy', 'Models, cost and efficiency', 'No review results recorded yet', 'Review notes and reports']) expect(html).toContain(label)
