...
function useCrewTrigger(profileId: string, projectId: string, triggerId: string): ProductAPITrigger | null | undefined {
...
function useCrewAttachmentAlias(workspacePath: string | null, projectId: string): string | null | undefined {
      ...
      <section className="border-b border-border px-4 py-3 last:border-b-0">
        ...
        <dl className="space-y-2 text-xs">
          <div className="flex items-baseline gap-2">
            ...
            <dd className="truncate font-mono text-foreground" title={step.crew_project_id}>{step.crew_project_id}</dd>
          </div>
          <div className="flex items-baseline gap-2">
