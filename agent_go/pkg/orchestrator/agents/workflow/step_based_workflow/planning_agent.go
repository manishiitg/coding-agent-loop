...
type AgentConfigs struct {
	...
	EnabledCustomTools           []string        `json:"enabled_custom_tools,omitempty"`            // optional additions, e.g. ["human_tools:get_notification_history"]; baseline workspace + three human tools are automatic
