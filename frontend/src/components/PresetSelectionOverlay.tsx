...
export const PresetSelectionOverlay: React.FC<PresetSelectionOverlayProps> = ({
  ...
  const handlePresetSave = async (
    ...
    _agentMode?: 'multi-agent' | 'workflow',
    ...
    try {
      ...
      const newPreset = await savePreset(label, query, selectedServers, selectedTools, selectedSkills, presetAgentMode, selectedFolder, llmConfig, useCodeExecutionMode, undefined, selectedSecrets, selectedGlobalSecretNames, browserMode, cdpPorts, icon)
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
      ...
      <PresetModal
        ...
        fixedAgentMode={getAgentModeFromCategory(modeCategory as ModeCategory) as 'multi-agent' | 'workflow'}
        agentMode={getAgentModeFromCategory(modeCategory as ModeCategory) as 'multi-agent' | 'workflow'}
      />
    </div>
  )
}
