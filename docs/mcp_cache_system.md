...
#### 1. `agent_go/pkg/mcpcache/manager.go` (691 lines)
...
#### 2. `agent_go/pkg/mcpcache/integration.go` (1250 lines)
...
#### 3. `agent_go/pkg/mcpcache/codegen/` (directory)
...
**File**: `agent_go/pkg/mcpcache/integration.go` (Line 212)
...
**File**: `agent_go/pkg/mcpcache/manager.go` (Lines 128-198)
...
**File**: `agent_go/pkg/mcpcache/manager.go` (Lines 200-230)
...
**File**: `agent_go/pkg/mcpcache/integration.go` (Lines 416-498)
...
**File**: `agent_go/pkg/mcpcache/integration.go` (Lines 548-691)
...
**File**: `agent_go/pkg/mcpcache/integration.go` (Lines 694-950)
...
**File**: `agent_go/pkg/mcpcache/integration.go` (Lines 952-1050)
...
**File**: `agent_go/pkg/mcpcache/integration.go` (Lines 454-468)
...
**File**: `agent_go/pkg/mcpcache/manager.go` (Lines 128-185)
...
#### 1. Pre-Normalization
**File**: `agent_go/pkg/mcpcache/integration.go` (Lines 972-975)
...
#### 2. Deep Copies
**File**: `agent_go/pkg/mcpcache/manager.go` (Lines 337-386)
...
**File**: `agent_go/pkg/mcpcache/manager.go` (Lines 601-632)
...
**File**: `agent_go/pkg/mcpcache/integration.go` (Lines 977-998)
...
#### During Retrieval
**File**: `agent_go/pkg/mcpcache/integration.go` (Lines 598-607)
...
### Event Types
**File**: `agent_go/pkg/mcpcache/integration.go` (Lines 36-86)
