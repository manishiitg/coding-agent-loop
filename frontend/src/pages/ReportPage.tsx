    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-background px-4 text-foreground">
        <div className="w-full max-w-md rounded-lg border border-border bg-card p-6 text-center shadow-sm">
          ...
          <p className="mb-4 text-sm text-muted-foreground">{isWrongPersonalAccount ? "Only the crew owner can open this dashboard. Ask them to share the underlying files instead." : "The dashboard URL must include a valid encoded workflow or Crew project path."}</p>
          {onBack && (
