...
| Engineering | Incident to Verified Recovery; Post-Incident Review and Actions; Engineering Operations Intelligence, Reliability Operations, Performance Engineering, FinOps | Seven Engineering Crew roles and four multi-Crew Automation Playbooks are locally installable with pending setup; FinOps reuses Finance Analyst. |
...
| Security | Finding to Verified Remediation; Access Exception to Verified Fix; Application Security Assessment and Remediation; Role and Permission Validation can be discovered here too | Three Security Crew roles and two multi-Crew Automation Playbooks are locally installable with pending setup; the role-permission guide remains under `browser-qa/`. |
