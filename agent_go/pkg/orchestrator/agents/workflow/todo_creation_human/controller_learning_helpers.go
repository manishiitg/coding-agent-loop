...
func (hcpo *HumanControlledTodoPlannerOrchestrator) readStepLearningMetadata(ctx context.Context, stepID string, stepPath string) (LearningMetadata, error) {
...
func (hcpo *HumanControlledTodoPlannerOrchestrator) CalculateStepHash(step PlanStepInterface) string {
	if step == nil {
		return ""
	}
...
func (hcpo *HumanControlledTodoPlannerOrchestrator) CheckAndResetStepHash(
	ctx context.Context,
...
func (hcpo *HumanControlledTodoPlannerOrchestrator) ResetLearningMetadata(
	ctx context.Context,
	stepID string,
	stepIndex int,
	stepPath string,
