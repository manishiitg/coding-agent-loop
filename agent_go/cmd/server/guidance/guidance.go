...
var referenceKinds = map[string]kindMeta{
	...
	"review-improve-log":  {Group: "system", Description: "Shared review/improve logging conventions: builder/review.html + builder/improve.html format, the one-time .md->.html migration, the F-/I- finding-id scheme, and the improve-decision block + close-out ritual. Load before writing either log from any /review-* or /improve-* skill.", Modes: []string{"workshop", "run"}},
