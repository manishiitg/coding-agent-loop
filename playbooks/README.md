...
| Engineering | Incident to Verified Recovery; Engineering Operations Intelligence, Reliability Operations, Performance Engineering, FinOps | Four Engineering Crew roles and two multi-Crew Automation Playbooks are locally installable with pending setup; FinOps reuses Finance Analyst. |
...
- This runs all 35 package-local contract suites; every multi-Crew Automation Playbook now has one.
