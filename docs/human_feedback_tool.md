...
|-----------|------|---------------|
| **Virtual Tool** | [`human_tools.go`](file:///Users/mipl/ai-work/mcp-agent/agent_go/cmd/server/virtual-tools/human_tools.go) | `CreateHumanTools()`, `handleHumanFeedback()` |
| **Backend Store** | [`human_feedback_store.go`](file:///Users/mipl/ai-work/mcp-agent/agent_go/cmd/server/virtual-tools/human_feedback_store.go) | `CreateRequest()`, `SubmitResponse()`, `WaitForResponse()`, `Cleanup()` |
| **API Endpoint** | [`server.go`](file:///Users/mipl/ai-work/mcp-agent/agent_go/cmd/server/server.go) | `handleSubmitHumanFeedback()` (POST `/api/human-feedback/submit`) |
| **Frontend UI** | [`HumanFeedbackToolCallDisplay.tsx`](file:///Users/mipl/ai-work/mcp-agent/frontend/src/components/events/tools/ToolCallSpecialRender/HumanFeedbackToolCallDisplay.tsx) | `HumanFeedbackToolCallDisplay` component |
| **Event Data Structures** | [`data.go`](file:///Users/mipl/ai-work/mcp-agent/agent_go/pkg/events/data.go) | `BlockingHumanFeedbackEvent`, `RequestHumanFeedbackEvent` |
| **Orchestrator Helpers** | [`base_orchestrator.go`](file:///Users/mipl/ai-work/mcp-agent/agent_go/pkg/orchestrator/base_orchestrator.go) | `RequestHumanFeedback()`, `RequestYesNoFeedback()`, `RequestMultipleChoiceFeedback()` |
...
**File:** [`human_tools.go`](file:///Users/mipl/ai-work/mcp-agent/agent_go/cmd/server/virtual-tools/human_tools.go)
...
**File:** [`HumanFeedbackToolCallDisplay.tsx`](file:///Users/mipl/ai-work/mcp-agent/frontend/src/components/events/tools/ToolCallSpecialRender/HumanFeedbackToolCallDisplay.tsx)
...
**File:** [`base_orchestrator.go`](file:///Users/mipl/ai-work/mcp-agent/agent_go/pkg/orchestrator/base_orchestrator.go)
...
- [Todo Creation Human Workflow](file:///Users/mipl/ai-work/mcp-agent/docs/todo_creation_human_workflow.md) - Uses human feedback for plan approval and variable confirmation
- [Virtual Tools](file:///Users/mipl/ai-work/mcp-agent/docs/) - Overview of all virtual tools
- [Event System](file:///Users/mipl/ai-work/mcp-agent/docs/) - How events coordinate frontend/backend
...
**File:** [`human_feedback_store.go`](file:///Users/mipl/ai-work/mcp-agent/agent_go/cmd/server/virtual-tools/human_feedback_store.go)
