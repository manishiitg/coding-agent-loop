...
func (hctpca *HumanControlledTodoPlannerConditionalAgent) conditionalSystemPromptProcessor(templateVars map[string]string, isCodeExecutionMode bool) string {
...
func (hctpca *HumanControlledTodoPlannerConditionalAgent) conditionalUserMessageProcessor(templateVars map[string]string) string {
	templateStr := `## 📝 TASK
**Condition**: {{.Question}}
...
func (hctpca *HumanControlledTodoPlannerConditionalAgent) decisionSystemPromptProcessor(templateVars map[string]string) string {
...
func (hctpca *HumanControlledTodoPlannerConditionalAgent) decisionUserMessageProcessor(templateVars map[string]string) string {
