...
var allKinds = map[string]kindMeta{
	...
	"improve-workflow":    {Group: "improve", Description: "Unified metric-driven workflow improvement across plan, eval, metrics, reports, KB, learnings, and db: harden, replan, or clean up the evidence stores from run/eval evidence", Modes: []string{"workshop"}},
