...
|-----------|-----------|---------|
| **Source of Truth** | [`mcpagent/events/data.go`](file:///Users/mipl/ai-work/mcp-agent/mcpagent/events/data.go) | Defines event structs (`ToolCallStartEvent`, etc.) |
| **Event Enums** | [`mcpagent/events/types.go`](file:///Users/mipl/ai-work/mcp-agent/mcpagent/events/types.go) | Defines `EventType` constants |
| **Schema Generator** | [`agent_go/cmd/schema-gen/main.go`](file:///Users/mipl/ai-work/mcp-agent/agent_go/cmd/schema-gen/main.go) | Go tool to generate JSON Schemas |
| **Frontend Config** | [`frontend/package.json`](file:///Users/mipl/ai-work/mcp-agent/frontend/package.json) | NPM scripts for TS generation |
| **Generated Schema** | [`agent_go/schemas/unified-events-complete.schema.json`](file:///Users/mipl/ai-work/mcp-agent/agent_go/schemas/unified-events-complete.schema.json) | Intermediate JSON Schema |
| **Generated TS** | [`frontend/src/generated/events.ts`](file:///Users/mipl/ai-work/mcp-agent/frontend/src/generated/events.ts) | Final TypeScript definitions |
...
1.  **Define Go Struct**: Add struct to [`mcpagent/events/data.go`](file:///Users/mipl/ai-work/mcp-agent/mcpagent/events/data.go).
2.  **Add to Union**: Add to `UnifiedEvent` in [`agent_go/cmd/schema-gen/main.go`](file:///Users/mipl/ai-work/mcp-agent/agent_go/cmd/schema-gen/main.go).
...
- [Frontend Documentation](file:///Users/mipl/ai-work/mcp-agent/frontend/README.md) - Frontend architecture
- [Backend Documentation](file:///Users/mipl/ai-work/mcp-agent/agent_go/README.md) - Backend architecture
