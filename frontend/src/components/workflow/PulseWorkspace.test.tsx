...
describe('PulseWorkspace information hierarchy', () => {
  it('shows drift status and review coverage before findings', () => {
    ...
    for (const label of ['Technical review', 'Strategic review', 'Learnings', 'Knowledge base', 'Report accuracy', 'Models, cost and efficiency', 'Checks and results', 'Review reports']) expect(html).toContain(label)
