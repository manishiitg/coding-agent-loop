...
export const WORKSPACE_ASK_AI_MESSAGE = {
  ...
  schedules: "Help me set up or change a schedule or webhook for this workflow. Ask what should run, what should trigger it, and any timing, route, or authentication requirements.",
